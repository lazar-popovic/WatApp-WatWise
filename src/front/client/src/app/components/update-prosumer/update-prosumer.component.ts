...
@Component({
  selector: 'app-update-prosumer',
  templateUrl: './update-prosumer.component.html',
  styleUrls: ['./update-prosumer.component.css']
})
export class UpdateProsumerComponent implements OnInit {
  @Input() user: any = {
    id: 0 as number,
    email: '' as string,
    firstname: '' as string,
  ...
  storeUser()
  {
    ...
    this.busy = this.userService.updateProsumer(this.user).subscribe((result: any) => {
